...
class Home extends HookConsumerWidget with HomeEvent, HomeState {
  const Home({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final todos = targetTodos(ref);
        ...
        body: ListView(
          ...
          children: [
            ...
            TextField(
              ...
              onSubmitted: (value) => onTodoSubmitted(
                ref,
            ...
            for (var i = 0; i < todos.length; i++) ...[
              ...
              Dismissible(
                ...
                onDismissed: (_) =>
                    onTodoDismissed(ref, selectedTodo: todos[i]),
                child: ProviderScope(
                  overrides: [
